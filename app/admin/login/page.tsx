                ...
                <div className="bg-black/40 border border-white/10 backdrop-blur-3xl rounded-[2.5rem] p-8 md:p-12 shadow-3xl relative overflow-hidden group">
                    ...
                    <form action={login} className="space-y-6">
                        ...
                        <div className="pt-2">
                            <Button 
                                type="submit" 
                                className="w-full h-12 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white border-0 shadow-lg shadow-cyan-500/20 rounded-xl font-bold text-base transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
                            >
                                Enter Dashboard
                            </Button>
                        </div>
